...
SELECT titulo, duracao_min FROM filme
WHERE genero = 'Comedia' AND duracao_min < 95 ;
...
SELECT titulo, classificacao, duracao_min FROM filme
WHERE classificacao = 12 AND duracao_min <= 120 ; 

SELECT titulo, genero FROM filme 
WHERE genero = 'Terror' OR genero = 'Policial';

SELECT titulo, genero, duracao_min, classificacao FROM filme 
...
SELECT titulo, genero, duracao_min FROM filme
WHERE genero = 'Animação' ORDER BY duracao_min DESC;

SELECT titulo, genero, classificacao FROM filme
WHERE classificacao = 14 ORDER BY genero ASC;

SELECT titulo, genero, duracao_min FROM filme
WHERE genero = 'Terror' ORDER BY duracao_min DESC;

SELECT titulo, classificacao, genero FROM filme 
WHERE genero = 'Ação' ORDER BY classificacao ASC;
